...
st.set_page_config(page_title="AI Projections | WhatsTheRate", layout="wide")
...
if model and df is not None:
    ...
    # Convert uncertainty to a 0-100% score
    confidence_score = max(0, min(100, 100 - (uncertainty / 0.005 * 100)))

    # 3. Tabs & Dual-Direction UI (INDENTED INSIDE IF BLOCK)
